                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: widget.quizLayout.getColorScheme().primaryContainer, // 배경 색상
                          borderRadius: BorderRadius.circular(30), // 모서리 둥글기
                          boxShadow: [
                            BoxShadow(
                              color: widget.quizLayout.getColorScheme().outline.withOpacity(0.5), // 그림자 색상
                              spreadRadius: 1,
                              blurRadius: 5,
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            SizedBox(
                                height: AppConfig
                                    .fontSize), // 텍스트를 수직 방향으로 약간 아래로 이동
                            Text(
                              '$score', // 점수 표시
                              style: TextStyle(
                                color: widget.quizLayout.getColorScheme().onPrimaryContainer, // 텍스트 색상
                      ...
                      SizedBox(
                        ...
                        child: FloatingActionButton(
                          foregroundColor: widget.quizLayout.getColorScheme().secondaryContainer,
                          onPressed: () {
                            _onPopInvoked(true);
                          },
                          child: Text("돌아가기",
