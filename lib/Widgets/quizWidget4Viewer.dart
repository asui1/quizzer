...
class _QuizView4State extends State<QuizView4> {
  ...
  void initState() {
    super.initState();
    loadQuiz();
    for (int i = 0; i < quizTest.getAnswers().length; i++) {
          ...
          children: <Widget>[
            ...
            Expanded(
              ...
              child: ListView.builder(
                itemCount: quizTest.getAnswers().length, // 마지막 "+" 버튼을 위해 +1
                      ...
                      children: <Widget>[
                        Expanded(
                          child: Container(
                            padding: EdgeInsets.symmetric(
                                horizontal: 10, vertical: 5), // 텍스트 주변에 여백 추가
                            ...
                            child: Text(
                              quizTest.getAnswerAt(index),
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  fontSize: fontSizeBase * 3), // 텍스트 스타일 설정
                            ),
                          ),
                        ),
                        Container(
                                ...
                                for (var key in rightKeys) {
                                  ...
                                  if (distance <= 20) {
                                    ...
                                    Offset position =
                                        linePaint.globalToLocal(GlobalPosition);
                                    ends[index] = position;
                                    curAnswer[index] = rightKeys.indexOf(key);
                                    break;
                                  } else {
                                    ends[index] = null;
                                  }
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: Text(
                              quizTest.getConnectionAnswerAt(index),
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  fontSize: fontSizeBase * 3), // 텍스트 스타일 설정
                            ),
